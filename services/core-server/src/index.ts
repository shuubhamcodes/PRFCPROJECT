...
const NODE_NAME = process.env.NODE_NAME || 'n2';
let BUFFER_MAX = parseInt(process.env.BUFFER_MAX || '1000', 10);
let CPU_EV_PER_SEC = parseInt(process.env.CPU_EV_PER_SEC || '100', 10);
...
const NEXT_HOP_URL = process.env.NEXT_HOP_URL || 'http://localhost:4030';
