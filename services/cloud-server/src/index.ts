...
const NODE_NAME = process.env.NODE_NAME || 'n3';
let BUFFER_MAX = parseInt(process.env.BUFFER_MAX || '5000', 10);
let CPU_EV_PER_SEC = parseInt(process.env.CPU_EV_PER_SEC || '200', 10);
